...
session.execute("DROP TABLE IF EXISTS curriculum.professors3")
session.execute("DROP TABLE IF EXISTS curriculum.schedules3")
session.execute("DROP TABLE IF EXISTS curriculum.courses3")
