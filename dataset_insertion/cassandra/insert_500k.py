...
session.execute("DROP TABLE IF EXISTS curriculum.professors2")
session.execute("DROP TABLE IF EXISTS curriculum.schedules2")
session.execute("DROP TABLE IF EXISTS curriculum.courses2")
