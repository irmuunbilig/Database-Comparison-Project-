...
# Query: Fetch all prof_ids and campus from courses table where campus is Papardo
query_prof_ids = "SELECT prof_id, campus FROM courses WHERE campus = 'Papardo' ALLOW FILTERING;"
