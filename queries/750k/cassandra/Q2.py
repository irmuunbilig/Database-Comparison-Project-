...
# Query: Fetch all prof_ids and campus from courses3 table where campus is Papardo
query_prof_ids = "SELECT prof_id, campus FROM courses3 WHERE campus = 'Papardo' ALLOW FILTERING;"
