...
# Step 1: Fetch all schedules2 for Spring semesters
schedule_query = {'semester': {'$regex': '^Spring'}}
schedules = execute_query(database['schedules2'], schedule_query)

# Extract the course IDs from the schedules
course_ids = {schedule['course_id'] for schedule in schedules}

# Step 2: Fetch courses2 taught at Papardo Campus with the extracted course_ids
...
# Step 3: Fetch the names of professors2 with the extracted prof_ids
